...
if __name__ == "__main__":
    ...
    parser.add_argument('--seed', dest='seed', default=0, type=int,
                        help='Random seed')
    parser.add_argument('--iter', dest='iter', default=0, type=int,
                        help='the number of seeds')
    parser.add_argument('--ave_acc', dest='ave_acc', type=float, default=0,
                        help='weight_decay')
    parser.add_argument('--ave_fgt', dest='ave_fgt', type=float, default=0,
                        help='weight_decay')
    parser.add_argument('--train_time', dest='train_time', type=float, default=0,
                        help='train_time')
    ########################Misc#########################
    ...
    parser.add_argument('--agent', dest='agent', default='PCR',
                        choices=['ER', 'EWC', 'AGEM', 'CNDPM', 'LWF', 'ICARL', 'GDUMB', 'ASER', 'SCR', 'PCR', 'DSD'],
    ...
    ####################SupContrast######################
    parser.add_argument('--temp', type=float, default=0.09,
